...
def seed_products(cursor, category_ids):
    ...
    product_data = [
        ...
        ("Nestle Maggi", "Ready-to-eat instant masala noodles.", "https://images.unsplash.com/photo-1612927601601-6638404737ce?w=800", cat1),
        ("Ketchup", "Tangy tomato ketchup for snacking.", "https://images.unsplash.com/photo-1585325701165-351af916e581?w=800", cat1),
        ("Garlic Paste", "Strong aromatic ginger garlic paste.", "https://images.unsplash.com/photo-1540148426945-6cf22a6b2383?w=800", cat1),
        ...
        ("Garlic", "Whole fresh garlic bulbs (100g).", "https://images.unsplash.com/photo-1540148426945-6cf22a6b2383?w=800", cat2),
        ...
        ("Cheese Slices", "Premium processed cheese slices.", "https://images.unsplash.com/photo-1618160702438-9b02ab6515c9?w=800", cat3),
        ...
        # Personal Care (cat4)
        ("Dettol Soap", "Anti-bacterial bathing soap.", "https://images.unsplash.com/photo-1600857544200-b2f666a9a2ec?w=800", cat4),
        ("Dove Shampoo", "Deeply nourishing hair therapy.", "https://images.unsplash.com/photo-1535585209827-a15fcdbc4c2d?w=800", cat4),
        ("Colgate Toothpaste", "Strong teeth with calcium boost.", "https://images.unsplash.com/photo-1570554886111-e80fcca6a029?w=800", cat4),
        ("Nivea Cream", "Intense hydration for dry skin.", "https://images.unsplash.com/photo-1556228720-195a672e8a03?w=800", cat4),
        ("Hand Wash", "Gentle liquid hand soap (250ml).", "https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=800", cat4),
        ("Aloe Vera Gel", "Pure soothing aloe vera gel.", "https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=800", cat4),
        ("Talcum Powder", "Refreshing floral scent powder.", "https://images.unsplash.com/photo-1521223344201-d169129f7b7d?w=800", cat4),
        ("Lip Balm", "Moisturizing care for chapped lips.", "https://images.unsplash.com/photo-1584017911766-d451b3d0e843?w=800", cat4),
        ("Sanitizer", "Alcohol-based instant hand rub.", "https://images.unsplash.com/photo-1584017911766-d451b3d0e843?w=800", cat4),
        ("Facewash", "Deep cleaning neem facewash.", "https://images.unsplash.com/photo-1556228720-195a672e8a03?w=800", cat4),
        ...
        ("Body Lotion", "Cocoa butter moisturizing lotion.", "https://images.unsplash.com/photo-1526947425960-945c6e72858f?w=800", cat4),
        ("Toothbrush", "Soft bristles for gentle cleaning.", "https://images.unsplash.com/photo-1570554886111-e80fcca6a029?w=800", cat4),
        ("Cotton Swabs", "Soft cotton tips for hygiene.", "https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=800", cat4),
        ...
        ("Vim Liquid", "Strong grease cutting dishwash.", "https://images.unsplash.com/photo-1585421514738-01798e348b17?w=800", cat5),
        ("Surf Excel", "Tough stain removal detergent.", "https://images.unsplash.com/photo-1582735689369-4fe89db7114c?w=800", cat5),
        ("Harpic Cleaner", "Professional grade toilet cleaner.", "https://images.unsplash.com/photo-1584813470613-5b1c1cad3d69?w=800", cat5),
        ("Garbage Bags", "Heavy-duty biodegradable bags.", "https://images.unsplash.com/photo-1618477461853-cf6ed80faba5?w=800", cat5),
        ("Matchboxes", "Safety matches (pack of 10).", "https://images.unsplash.com/photo-1563861826100-9cb868fdbe1c?w=800", cat5),
        ("Kitchen Towels", "Highly absorbent paper towels.", "https://images.unsplash.com/photo-1583947215259-38e31be8751f?w=800", cat5),
        ("Floor Cleaner", "Pine scented disinfectant liquid.", "https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=800", cat5),
        ("Scrub Pad", "Durable nylon dishwashing scrub.", "https://images.unsplash.com/photo-1585421514738-01798e348b17?w=800", cat5),
        ...
        ("Sponges", "Multi-purpose cleaning sponges.", "https://images.unsplash.com/photo-1585421514738-01798e348b17?w=800", cat5),
        ("Liquid Detergent", "Gentle wash for woolens.", "https://images.unsplash.com/photo-1582735689369-4fe89db7114c?w=800", cat5),
        ("Surface Sanitizer", "99.9% germ killing spray.", "https://images.unsplash.com/photo-1584017911766-d451b3d0e843?w=800", cat5),
        ("Cotton Cloths", "Soft reusable kitchen wipes.", "https://images.unsplash.com/photo-1583947215259-38e31be8751f?w=800", cat5)
    ]
